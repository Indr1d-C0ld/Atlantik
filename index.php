...
try {
    ...
    echo '<!doctype html><meta charset="utf-8"><title>Atlantik — configurazione</title>'
        . '<style>body{font:16px/1.6 system-ui,sans-serif;background:#14181a;color:#c8cdd0;'
        . 'max-width:44rem;margin:4rem auto;padding:0 1.5rem}code{background:#222a2d;padding:.15em .4em;'
        . 'border-radius:3px}h1{color:#b8925a}</style>'
