...
return [
    ...
    // --- Scoperta -------------------------------------------------------------
    ['skey' => 'periscopio_att','name' => 'Periscopio d\'attacco',     'category' => 'scoperta',    'compartment' => 'zentrale',  'specialty' => 'zentrale',   'repairable_sea' => 0, 'repair_hours' => 0,  'failure_rate' => 0.00018, 'note' => 'Piegato o allagato non si ripara a mare: bisogna rientrare.'],
    ['skey' => 'periscopio_osc','name' => 'Periscopio di scoperta',    'category' => 'scoperta',    'compartment' => 'zentrale',  'specialty' => 'zentrale',   'repairable_sea' => 0, 'repair_hours' => 0,  'failure_rate' => 0.00015, 'note' => null],
    ...
    // --- Scafo e armamento -----------------------------------------------------
    ['skey' => 'scafo',       'name' => 'Scafo resistente',            'category' => 'scafo',       'compartment' => 'zentrale',  'specialty' => 'zentrale',   'repairable_sea' => 0, 'repair_hours' => 0,  'failure_rate' => 0.00004, 'note' => 'Le deformazioni da pressione non si raddrizzano: restano, e abbassano la quota di collasso.'],
